...
if __name__ == '__main__':
    ...
    textfile=open('/home/sauvageduck24/Escritorio/LTM/losses/simple_transformer_adder.txt','a')
    #textfile=open('/home/sauvageduck24/Escritorio/LTM/losses/ltm_transformer_adder.txt','a')
